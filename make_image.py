...
#     'width': {1: 19, 2: 19, 3: 33} #длина строки
# }
#
...
dict_list = {
    'B':{'data': Boss_dr, 'class_img': {1: 'image_one_boss', 2: 'image_two_boss'}, 'dir_save':'Начальники'},
    'HB':{'data': Boss_ubiley, 'class_img': {1: 'image_one_boss', 2: 'image_two_boss'}, 'dir_save':'Начальники_Юбилей'},
    'S':{'data': Staff_ubiley, 'class_img': {1: 'image_one_person', 2: 'image_two_person', 3: 'image_three_person'} , 'dir_save':'Сотрудники'}
}
...
def save_pic(list_abv):
    ...
    for key in list:
        ...
        if quantity_staff >= 4:
            ...
            class_img = dict_list[list_abv]['class_img'][quantity_staff]
            if list_abv=='S':
            ...
            function.make_HB_pic(img_draw, list[key], class_img)
